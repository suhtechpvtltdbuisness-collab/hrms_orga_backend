...
import appraisalTemplateRouter from "./router/appraisalTemplateRouter.js";
import appraisalRouter from "./router/appraisalRouter.js";
import energyPointRouter from "./router/energyPointRouter.js";
import attendanceRouter from "./router/attendanceRouter.js";
import attendanceRequestRouter from "./router/attendanceRequestRouter.js";
...
router.use("/appraisal-templates", appraisalTemplateRouter);
router.use("/appraisals", appraisalRouter);
router.use("/energy-points", energyPointRouter);
