...
CREATE TABLE "payroll_entry" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "payroll_entry_emp_period_unique" UNIQUE("emp_id", "period_start", "period_end")
);
--> statement-breakpoint
CREATE TABLE "salary_slip" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "salary_slip_payroll_entry_unique" UNIQUE("payroll_entry_id"),
	CONSTRAINT "salary_slip_number_unique" UNIQUE("slip_number")
);
--> statement-breakpoint
...
ALTER TABLE "salary_structure_component" ADD CONSTRAINT "salary_structure_component_salary_structure_id_fk" FOREIGN KEY ("salary_structure_id") REFERENCES "public"."salary_structure"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "salary_structure_component" ADD CONSTRAINT "salary_structure_component_salary_component_id_fk" FOREIGN KEY ("salary_component_id") REFERENCES "public"."salary_component"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "salary_structure_assignment" ADD CONSTRAINT "salary_structure_assignment_salary_structure_id_fk" FOREIGN KEY ("salary_structure_id") REFERENCES "public"."salary_structure"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "additional_salary" ADD CONSTRAINT "additional_salary_salary_component_id_fk" FOREIGN KEY ("salary_component_id") REFERENCES "public"."salary_component"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payroll_entry" ADD CONSTRAINT "payroll_entry_salary_structure_id_fk" FOREIGN KEY ("salary_structure_id") REFERENCES "public"."salary_structure"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payroll_entry" ADD CONSTRAINT "payroll_entry_salary_structure_assignment_id_fk" FOREIGN KEY ("salary_structure_assignment_id") REFERENCES "public"."salary_structure_assignment"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "salary_slip" ADD CONSTRAINT "salary_slip_payroll_entry_id_fk" FOREIGN KEY ("payroll_entry_id") REFERENCES "public"."payroll_entry"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payroll_accounting" ADD CONSTRAINT "payroll_accounting_payroll_entry_id_fk" FOREIGN KEY ("payroll_entry_id") REFERENCES "public"."payroll_entry"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payroll_accounting" ADD CONSTRAINT "payroll_accounting_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
